...
@TeleOp(name="DriverControl", group="Main Modes")
public class DriverControl extends LinearOpMode {
    ...
    public void checkForUserInput(){
        ...
        if(gamepad1.right_stick_button && droneLauncherArmingTimer.seconds() > 90){
